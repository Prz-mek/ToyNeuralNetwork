...
const changeModel = (model) => {
    net = new NetworkView(model, getWidthNeural, getHeight, 0.05);
}

const init = () => {
    changeModel(sigmoidNet);
    canvDraw.width = 224;
    canvDraw.height = 224;
...
document.getElementById('netModel1').onclick = () => changeModel(sigmoidNet);
document.getElementById('netModel2').onclick = () => changeModel(tanhNet);
